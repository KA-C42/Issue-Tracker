...
// Create new issue
// TODO: decide if i want req.user.sub validated universally when needed or not
...
// - Project creator
//
// TODO: Add separate patch options for status and assignee,
//       available to project members and/or the assignee if there is one
issueRouter.patch(
  '/:id',
